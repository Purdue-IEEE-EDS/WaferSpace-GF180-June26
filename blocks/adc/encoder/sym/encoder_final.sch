...
bus=true}
N 800 -330 860 -330 {lab=CLK_EVAL}
N 1160 -1630 1230 -1630 {lab=b[0]}
N 1160 -1610 1230 -1610 {lab=b[1]}
N 1160 -1590 1230 -1590 {lab=b[2]}
N 1160 -1570 1230 -1570 {lab=b[3]}
N 1160 -1550 1230 -1550 {lab=b[4]}
N 1160 -1530 1230 -1530 {lab=b[5]}
N 1240 -1740 1240 -1470 {lab=b[5:0]
bus=true}
N 1240 -1610 1500 -1610 {lab=b[5:0]
bus=true}
N 1450 -1670 1500 -1670 {lab=VDD}
N 1450 -1650 1500 -1650 {lab=RST}
N 1450 -1630 1510 -1630 {lab=CLK_EVAL}
...
C {ipin.sym} 820 -330 0 0 {name=p14 lab=CLK_EVAL}
C {ipin.sym} 1010 -1690 0 0 {name=p12 lab=VDD}
C {ipin.sym} 1010 -260 0 0 {name=p13 lab=GND}
C {bus_connect_nolab.sym} 1230 -1630 0 0 {name=r1}
C {bus_connect_nolab.sym} 1230 -1610 0 0 {name=r3}
C {bus_connect_nolab.sym} 1230 -1590 0 0 {name=r4}
C {bus_connect_nolab.sym} 1230 -1570 0 0 {name=r5}
C {bus_connect_nolab.sym} 1230 -1550 0 0 {name=r6}
C {bus_connect_nolab.sym} 1230 -1530 0 0 {name=r7}
C {lab_wire.sym} 1220 -1630 0 0 {name=p15 sig_type=std_logic lab=b[0]}
C {lab_wire.sym} 1220 -1570 0 0 {name=p78 sig_type=std_logic lab=b[3]}
C {lab_wire.sym} 1220 -1610 0 0 {name=p79 sig_type=std_logic lab=b[1]}
C {lab_wire.sym} 1220 -1550 0 0 {name=p80 sig_type=std_logic lab=b[4]}
C {lab_wire.sym} 1220 -1590 0 0 {name=p81 sig_type=std_logic lab=b[2]}
C {lab_wire.sym} 1220 -1530 0 0 {name=p82 sig_type=std_logic lab=b[5]}
C {lab_wire.sym} 1240 -1690 0 0 {name=p83 sig_type=std_logic lab=b[5:0]}
C {opin.sym} 1830 -1670 0 0 {name=p84 lab=b_out[5:0]}
C {lab_wire.sym} 1480 -1670 0 0 {name=p85 sig_type=std_logic lab=VDD}
