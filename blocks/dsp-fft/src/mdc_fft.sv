...
(
    ...
    always_ff @(posedge clk, negedge rst) begin 
        if (!rst) in_valid_reg <= '0;
        else in_valid_reg <= in_valid;
    end
    
    logic [10:0] din_re0_reg, din_re1_reg, din_re2_reg, din_re3_reg;
    logic [10:0] din_im0_reg, din_im1_reg, din_im2_reg, din_im3_reg; 
    ...
    always_ff @(posedge clk) begin 
        din_re0_reg <= {din_re0, 4'b0};
        din_re1_reg <= {din_re1, 4'b0}; 
        din_re2_reg <= {din_re2, 4'b0}; 
        din_re3_reg <= {din_re3, 4'b0}; 
        din_im0_reg <= {din_im0, 4'b0};
        din_im1_reg <= {din_im1, 4'b0};
        din_im2_reg <= {din_im2, 4'b0};
        din_im3_reg <= {din_im3, 4'b0}; 
