...
module parallel_to_serial(
    ...
    (* keep *) logic pulse0_p, pulse1_p, pulse2_p, pulse3_p; 
    ...
    (* keep *) ring_counter rc2 (.clk(adc_clk), .rst, .count(pulse2_p));
    (* keep *) ring_counter rc3 (.clk(adc_clk), .rst, .count(pulse3_p));
