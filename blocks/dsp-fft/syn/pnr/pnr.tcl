read_lef /usr/share/pdk//gf180mcuD/libs.ref/gf180mcu_fd_sc_mcu9t5v0/techlef/gf180mcu_fd_sc_mcu9t5v0__max.tlef
read_lef /usr/share/pdk//gf180mcuD/libs.ref/gf180mcu_fd_sc_mcu9t5v0/lef/gf180mcu_fd_sc_mcu9t5v0.lef
...
detailed_route -output_drc syn/route_drc.rpt -bottom_routing_layer Metal1 -top_routing_layer Metal5

estimate_parasitics -global_routing
report_checks -path_delay max -slack_max -0.0 -group_count 5
report_checks -path_delay min -slack_max -0.0 -group_count 5
report_tns
report_wns
report_clock_skew
report_design_area
