...
(
    ...
    input  logic signed [11:0] din0, din1, din2, din3,

    output logic              valid_out,
    output logic signed [11:0] dout0, dout1, dout2, dout3
);
    ...
    logic [11:0] s0_in [0:3];
    logic [11:0] s1_in [0:3];
    logic [11:0] s2_in [0:3];
    logic [11:0] s3_in [0:3];
