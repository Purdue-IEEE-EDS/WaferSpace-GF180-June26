...
(
    ...
    reorder_im_re (
        ...
        .din0({pdata_re0, pdata_im0}), .din1({pdata_re1, pdata_im1}), .din2({pdata_re2, pdata_im2}), .din3({pdata_re3, pdata_im3}),

        .valid_out(reorder_val),
        .dout0({fft_re0, fft_im0}), .dout1({fft_re1, fft_im1}), .dout2({fft_re2, fft_im2}), .dout3({fft_re3, fft_im3})
    );
